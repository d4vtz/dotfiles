# Generated by Powerlevel10k configuration wizard on 2026-08-26 at 14:12 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=61
  # Custom icon.
  ...
  # Anaconda segment format. The followin/g parameters are available within the expansion.
  #
